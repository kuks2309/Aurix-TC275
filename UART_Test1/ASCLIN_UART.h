...
/*------------------------------------------------Global Variables----------------------------------------------------*/
/*********************************************************************************************************************/
extern uint8 cnt_led;                           /* Length counter for UART messages */
extern int cnt_rcv;                              /* Receive counter for UART messages */
extern uint8 g_rxRcvBuffer[];                    /* Receive buffer for UART messages */
